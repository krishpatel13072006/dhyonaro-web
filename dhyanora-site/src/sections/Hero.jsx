    ...
    <section className="relative w-full min-h-screen flex items-center overflow-hidden bg-[#172451] pt-20">
      ...
      <div className="relative z-30 w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-12 py-16 md:py-24">
        <div className="max-w-2xl">
          ...
          >
            <Link href="/companies" className="btn-blue group justify-center sm:justify-start">
              Explore Our Companies
              <ArrowRight size={15} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/about" className="btn-outline-white justify-center sm:justify-start">
              Our Full Story
            </Link>
          </motion.div>
        </div>
