        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 pb-24 pt-8">
          ...
          <div className="lg:col-span-4 flex flex-col gap-10">
            <Link to="/" className="inline-block group">
              <img src={DhyonoraLogo2} alt="Dhyanora Group - Leading Industrial Group in Ahmedabad, Gujarat" className="h-14 w-auto group-hover:brightness-110 transition-all duration-300" />
            </Link>
