        ...
        <ScrollReveal y={-40} x={0}>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
            <div className="max-w-3xl">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-black text-slate-900 tracking-tight leading-[1.1]">
                Discipline & purpose behind <br className="hidden md:block"/> every business decision.
              </h2>
              
              <p className="text-lg text-slate-500 leading-relaxed mt-6 max-w-2xl font-medium">
