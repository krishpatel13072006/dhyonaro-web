      ...
      <main className="bg-off-white">
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-white pt-20">
          ...
          <div className="relative z-20 text-center px-6">
            ...
            <h1 className="text-6xl md:text-8xl font-heading font-black text-white uppercase italic">Our <span className="text-gold-dark">Team.</span></h1>
          </div>
        </section>
        ...
        <section className="py-32 px-6 bg-white border-y border-navy/5">
           <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
              <div className="flex-1 order-2 lg:order-1">
                 ...
                 <h2 className="text-4xl md:text-6xl font-heading font-black text-navy uppercase italic mb-10 leading-tight">Built on <br /><span className="text-gold-dark">Discipline.</span></h2>
                 <div className="space-y-8 text-xl text-navy/60 leading-relaxed font-bold mb-12">
                    <p>
                 ...
                 <div className="flex items-center gap-6 p-6 bg-off-white rounded-3xl border border-navy/5 w-fit">
                    <div className="w-16 h-16 bg-navy rounded-full flex items-center justify-center text-gold shadow-lg">
                       <User size={32} />
                    </div>
                    <div>
                       <div className="text-navy font-heading font-black uppercase tracking-widest text-lg">The Visionary</div>
                       <div className="text-navy/30 text-[10px] uppercase font-black tracking-widest mt-1">Founder, Dhyanora Group</div>
                    </div>
                 </div>
              </div>
              <div className="flex-1 w-full order-1 lg:order-2">
                 <div className="aspect-[4/5] rounded-[4rem] overflow-hidden border border-navy/10 shadow-2xl relative group">
        ...
        <section className="py-32 px-6">
           <div className="max-w-4xl mx-auto text-center bg-navy p-16 md:p-24 rounded-[4rem] border-navy-dark relative overflow-hidden shadow-2xl">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gold/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
              <h2 className="text-4xl md:text-7xl font-heading font-black text-white uppercase mb-10 italic leading-tight">Join the <br /><span className="text-gold">Family.</span></h2>
              <p className="text-xl text-white/40 mb-12 max-w-2xl mx-auto font-bold">
              ...
              <button className="bg-gold text-navy px-12 py-6 rounded-full font-black uppercase tracking-widest text-sm hover:scale-105 transition-all shadow-xl flex items-center justify-center gap-3 mx-auto">
