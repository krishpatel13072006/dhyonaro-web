      ...
      <main className="bg-white">
        ...
        <section className="relative min-h-[50vh] md:min-h-[70vh] flex items-center justify-center overflow-hidden bg-white pt-20">
          ...
          <div className="relative z-20 text-center px-6">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-9xl font-heading font-black text-white uppercase italic leading-none">Mahantam <br /><span className="text-gold">Industrial Park.</span></h1>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-32 px-6 bg-white border-y border-navy/5">
           <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
              <div className="flex-1">
                 ...
                 <h2 className="text-3xl md:text-6xl font-heading font-black text-navy uppercase italic mb-8 md:mb-10 leading-tight">About the <br/><span className="text-gold-dark">Park.</span></h2>
              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                 {[
                   ...
                   <div key={i} className="p-8 md:p-10 bg-off-white border border-navy/5 flex flex-col justify-center shadow-xl rounded-[2rem] md:rounded-[3rem] hover:bg-navy group transition-all duration-500">
                      ...
                      <p className="text-xs md:text-sm text-navy/40 group-hover:text-white/40 font-bold leading-relaxed transition-all">{item.desc}</p>
                   </div>
                 ))}
              </div>
           </div>
        ...
        <section className="py-20 md:py-40 px-6 bg-white border-y border-navy/5">
           <div className="max-w-7xl mx-auto">
              <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                 <div className="flex-1">
                    <h2 className="text-3xl md:text-6xl font-heading font-black text-navy uppercase mb-8 md:mb-12 leading-tight">Why Choose <br /><span className="text-gold-dark">Mahantam Park.</span></h2>
                    <ul className="space-y-6 md:space-y-8">
                       {[
                         ...
                         <li key={i} className="flex items-center gap-4 md:gap-6 text-lg md:text-xl text-navy/40 font-bold">
                            <ShieldCheck className="text-gold-dark flex-shrink-0" size={window.innerWidth < 768 ? 20 : 28} /> {item}
                         </li>
                       ))}
                    </ul>
                 </div>
        ...
        <section className="py-24 px-6 bg-white text-center">
           <div className="max-w-4xl mx-auto bg-navy p-12 md:p-20 rounded-[3rem] shadow-2xl relative overflow-hidden">
              ...
              <h2 className="text-3xl md:text-5xl font-heading font-black text-white uppercase mb-6 italic leading-[0.9]">Ready to <br /><span className="text-gold">Scale Up?</span></h2>
              <p className="text-lg text-white/40 mb-10 max-w-xl mx-auto font-bold">
