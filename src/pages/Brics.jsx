  ...
  return (
    <>
      ...
      <main className="relative">
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-navy pt-[165px]">
          <MovingMesh />
          ...
          <div className="relative z-20 w-full max-w-7xl mx-auto px-6 text-center">
            ...
            >
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gold/10 backdrop-blur-xl border border-gold/20 rounded-3xl mb-10 text-gold shadow-[0_0_50px_rgba(242,201,76,0.1)]">
                <Building2 size={36} />
              </div>
              
              <h1 className="font-heading font-black uppercase leading-[1] text-cream mb-8" style={{ fontSize: "clamp(3rem, 10vw, 6.5rem)" }}>
        ...
        {/* About Section */}
        <section className="py-32 px-6 bg-navy relative z-20 border-t border-white/5">
           ...
           <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              ...
              <div className="order-1 lg:order-2">
                 <div className="mb-6 flex items-center gap-4">
                    ...
                    <span className="text-gold text-xs font-bold uppercase tracking-[0.3em]">Logistics</span>
                 </div>
                 <h2 className="text-5xl md:text-6xl mb-8 font-heading font-black text-cream leading-tight uppercase italic">Reliable <br /><span className="text-gold">Delivery.</span></h2>
                 <p className="text-xl text-gray-light/40 mb-10 leading-relaxed max-w-xl font-medium">
                 ...
                 <ul className="space-y-4 mb-10">
                    {[
                      ...
                      <li key={i} className="flex items-center gap-3 text-cream/70 font-medium">
                         <span className="text-gold">{item.icon}</span> {item.text}
                      </li>
                    ))}
                 </ul>
                 <button className="group flex items-center gap-3 text-gold font-bold text-lg hover:gap-5 transition-all uppercase tracking-widest text-sm">
        ...
        <section className="py-32 px-6">
           <div className="max-w-4xl mx-auto text-center glass-card p-16 border-white/5 relative overflow-hidden">
              <h2 className="text-4xl md:text-6xl font-heading font-black text-cream uppercase mb-8 italic">Ready to <span className="text-gold">Start Building?</span></h2>
