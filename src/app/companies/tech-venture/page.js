...
import { 
  ...
  CheckCircle2, Star, Quote, Globe, Cpu, Battery, Settings2, Phone
} from 'lucide-react';
  ...
  return (
    <>
      ...
      <main className="bg-white overflow-x-hidden">
        ...
        <section className="relative h-screen w-full overflow-hidden flex items-center justify-center bg-[#172451]">
          ...
          <div className="relative z-30 text-center px-6 max-w-5xl mx-auto">
            ...
            <ScrollReveal delay={0.6} y={20} x={0}>
              <Link href="/contact" className="bg-[#fad77e] hover:bg-amber-400 text-[#172451] font-heading font-black uppercase tracking-widest text-[11px] py-4 px-8 rounded-xl transition-all inline-flex items-center gap-3 shadow-xl shadow-amber-500/20">
        ...
        <div className="bg-slate-50 py-4 border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="flex items-center gap-2 text-slate-400 text-xs md:text-sm">
              <Link href="/" className="hover:text-[#172451] transition-colors"><Home size={14} /></Link>
              <ChevronRight size={12} />
              <Link href="/companies" className="hover:text-[#172451] transition-colors">Our Companies</Link>
              <ChevronRight size={12} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <ScrollReveal x={60} y={0} delay={0.2}>
                <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-square">
                  <img src={techVentureMainImg.src} alt="Pramukh Techventures Premium Technology Retail Showroom and Customer Experience Center" className="w-full h-full object-cover" />
              ...
              >
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center">
                  <ScrollReveal x={i % 2 === 0 ? 60 : -60} y={0} delay={0.2}>
                    ...
                    <h3 className="text-2xl md:text-4xl font-heading font-black text-[#172451] uppercase mb-8">
                      {cat.title}
                    </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-24">
              ...
              <ScrollReveal x={60} y={0} delay={0.2}>
                <div className="relative rounded-[3rem] overflow-hidden shadow-2xl aspect-[4/3] group">
                  <img src={daewooShowroom.src} alt="DAEWOO India Authorized Franchise Showroom by Pramukh Techventures" className="w-full h-full object-cover transition-transform duration-[3s] group-hover:scale-110" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <ScrollReveal y={40} delay={0.2} className="md:col-span-2">
                <div className="relative rounded-[2.5rem] overflow-hidden group h-full min-h-[300px]">
                  <img src={daewooBattery.src} alt="DAEWOO Industrial Strength Batteries and Power Solutions - Pramukh Techventures" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[3s] group-hover:scale-105" />
              ...
              <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">
                ...
                <div className="w-full md:w-1/2">
                  <ScrollReveal x={50} delay={0.2}>
                    ...
                    <Link href="/contact" className="btn-blue inline-flex items-center">
                      Learn More
                    </Link>
                  </ScrollReveal>
                </div>
        ...
        <section className="py-16 bg-white px-6 border-t border-slate-100">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              
              {/* Card 1: Call Us */}
              <motion.a 
                href="tel:+919898062112"
              ...
              >
                <div className="relative z-10 space-y-4">
                  ...
                  <p className="text-slate-600 group-hover:text-white/80 font-sans text-sm md:text-base font-semibold leading-relaxed transition-colors duration-300">
                    Shop No. 26,27,28 The Crown,<br />
                    Opp. Kalhar Bunglow, Nr. Gangotri Circle,<br />
              ...
              <motion.a 
                href="mailto:pramukhtechventurespvtltd@gmail.com"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
