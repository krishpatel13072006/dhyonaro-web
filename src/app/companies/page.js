...
const FeatureCard = ({ img, icon: Icon, accent, title, desc, dark = false, sector, to }) => (
  ...
  >
    <div className="relative overflow-hidden rounded-xl m-3 mb-0" style={{ height: '210px' }}>
      <Image src={img} alt={title} fill className="object-cover group-hover:scale-105 transition-transform duration-700 rounded-xl" />
    </div>
      ...
      <main className="bg-white text-[#172451] overflow-x-hidden">
        ...
        <section className="bg-white relative mt-0" ref={overviewRef}>
          <div className="relative w-full pt-16 pb-24 md:pt-20 md:pb-28 overflow-hidden flex flex-col items-center justify-center">
            <img src={sectorDiversityImg.src} alt="Dhyanora Group Strategic Growth and Diversified Business Sectors in Gujarat" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-28 relative z-10">
            ...
            <ScrollReveal delay={0.05} y={40} x={0}>
              <div className="relative rounded-3xl overflow-hidden shadow-2xl w-full h-[45vh] md:h-[60vh] min-h-[300px] md:min-h-[420px] mb-10 md:mb-12 group">
                <img src={pramukhImportExportMainImg.src} alt="Pramukh Import Export - Leading Metal Scrap Trading Company in Gujarat" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[1.4s] ease-out" />
            ...
            <ScrollRevealGroup staggerDelay={0.15} y={50} x={0} className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                { icon: Settings2, title: 'KEY MATERIALS', sector: 'TRADING', img: keyMaterialsImg.src, desc: 'MS Scrap, Cast Iron, Melting Scrap, Copper, Aluminium, Brass, and Stainless Steel — sourced to exacting grade standards.' },
                { icon: Globe2, title: 'GLOBAL SOURCING', sector: 'SOURCING', img: globalSourcingImg.src, desc: 'Leveraging a vast international and domestic supplier network for steady, reliable procurement across geographies.' },
                { icon: ShieldCheck, title: 'QUALITY ASSURANCE', sector: 'QUALITY', img: qualityAssuranceImg.src, desc: 'Every batch meticulously graded and verified for purity and strict industrial compliance before delivery.' },
              ].map((f) => (
            ...
            <ScrollReveal delay={0.4} className="mt-12 flex justify-center">
               <Link href="/companies/import-export" className="btn-blue inline-flex items-center gap-3">
        ...
        <section className="bg-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-28 relative z-10">
            ...
            <ScrollReveal delay={0.05} y={40} x={0}>
              <div className="relative rounded-3xl overflow-hidden shadow-2xl w-full h-[45vh] md:h-[60vh] min-h-[300px] md:min-h-[420px] mb-10 md:mb-12 group">
                <img src={techVentureMainImg.src} alt="Pramukh Techventures - Authorized Electronics Retailer in Ahmedabad" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[1.4s] ease-out" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <div className="absolute top-4 right-4 md:top-6 md:right-6 bg-white/90 backdrop-blur-sm px-3 py-1.5 md:px-4 md:py-2 rounded-full font-bold text-[9px] md:text-xs text-[#172451] shadow-lg flex items-center gap-2">
            ...
            <ScrollReveal delay={0.4} className="mt-12 flex justify-center">
               <Link href="/companies/tech-venture" className="btn-blue inline-flex items-center gap-3">
        ...
        <section id="shreeji-infra" className="bg-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-28 relative z-10">
            ...
            <ScrollReveal delay={0.05} y={40} x={0}>
              <div className="relative rounded-3xl overflow-hidden shadow-2xl w-full h-[45vh] md:h-[60vh] min-h-[300px] md:min-h-[420px] mb-10 md:mb-12 group">
                <img src={shreejiMainImg.src} alt="Shreeji Infra - Mahantam Industrial Park and Infrastructure Development" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[1.4s] ease-out" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <div className="absolute top-4 right-4 md:top-6 md:right-6 bg-white/90 backdrop-blur-sm px-3 py-1.5 md:px-4 md:py-2 rounded-full font-bold text-[9px] md:text-xs text-[#172451] shadow-lg flex items-center gap-2">
            ...
            <ScrollRevealGroup staggerDelay={0.15} y={50} x={0} className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                { icon: Factory, title: 'Industrial Sheds', sector: 'INFRA', img: industrialShedImg.src, desc: 'Custom-built manufacturing spaces with optimized clear heights and reinforced flooring.' },
                { icon: MapPin, title: 'Strategic Connectivity', sector: 'LOCATION', img: shreejiInfraTechImg.src, desc: 'Located within the golden industrial corridor of Sanand, providing instant access to major logistics hubs.' },
                { icon: ShieldCheck, title: 'Secure Titles', sector: 'LEGAL', img: secureTilesImg.src, desc: '100% legal transparency and verified documentation for peace of mind.' },
              ].map((f) => (
            ...
            <ScrollReveal delay={0.4} className="mt-12 flex justify-center">
               <Link href="/companies/shreeji-infra" className="btn-blue inline-flex items-center gap-3">
